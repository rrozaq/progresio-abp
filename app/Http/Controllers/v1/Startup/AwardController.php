...
class AwardController extends Controller
{
    ...
    {
        return AwardResource::collection(AwardStartup::where('startup_id', Auth::guard('startup')->user()->id)->get());
    }
